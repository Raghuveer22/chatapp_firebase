...
class _SearchPageState extends State<SearchPage> {
    ...
    if(searchController.text.isNotEmpty)
      {
        ...
        await DatabaseService().searchByName(searchController.text.toString()).then((snapshot){
         setState(() {
 ...
 async { await DatabaseService(uid: user!.uid).isUserJoined(groupName, groupId, userName).then((value){
   setState(() {
          isJoined=value;
   });
 });
